# NPC vs Day2 unphased through dmrseq
...
# Keep NPCs and Day 2 neurons

neuro.BSseq <- neuro.BSseq[, !grepl("D6", pData(neuro.BSseq)$Samples)]

# Rename samples

neuro.BSseq$Samples <- c("2.Day2", "1.NPC", "2.Day2", "1.NPC", "2.Day2", "1.NPC")
...
keepLoci.ex <- which(rowSums(cov[, neuro.BSseq$Samples == "1.NPC"] > 0) >= 3 &
                       rowSums(cov[, neuro.BSseq$Samples == "2.Day2"] > 0) >= 3)
