---
title: "Dnmt1_differential_expression_analysis"
author: "Kaan Okay"
date: "10/30/2023"
...
```{r, message=FALSE}
expression_matrix <- read.delim("featureCounts.EM.KOs.txt", header = T, row.names = 1)
```
...
```{r}
group <- factor(c("Control", "Control", "Control", "Control", "Dnmt1", "Dnmt1", "Dnmt1", "Dnmt1"))
