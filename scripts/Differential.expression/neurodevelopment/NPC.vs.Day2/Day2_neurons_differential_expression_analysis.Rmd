---
title: "Day2_neurons_differential_expression_analysis"
author: "Kaan Okay"
date: "02/20/2024"
...
```{r, message=FALSE}
expression_matrix <- read.delim("featureCounts.neurodevelopment.txt", header = T, row.names = 1)
```
...
```{r}
group <- factor(c("NPC", "NPC", "NPC", "Day2", "Day2", "Day2"))
