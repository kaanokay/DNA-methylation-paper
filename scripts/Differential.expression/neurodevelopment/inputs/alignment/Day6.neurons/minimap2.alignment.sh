...
Library1.2.3.barcode03.merged.fastq | samtools view -h -b -q 40 -F 2304 --threads 128 -Sb - | samtools sort - --threads 128 \
> Library1.2.3.barcode03.bam

minimap2 -t 128 \
-uf \
-ax splice -y \
UCSC_Mus_musculus.GRCm38_genome.fa \
Library1.2.3.barcode07.merged.fastq | samtools view -h -b -q 40 -F 2304 --threads 128 -Sb - | samtools sort - --threads 128 \
> Library1.2.3.barcode07.bam

minimap2 -t 128 \
-uf \
-ax splice -y \
UCSC_Mus_musculus.GRCm38_genome.fa \
Library1.2.3.barcode10.merged.fastq | samtools view -h -b -q 40 -F 2304 --threads 128 -Sb - | samtools sort - --threads 128 \
> Library1.2.3.barcode10.bam
exit